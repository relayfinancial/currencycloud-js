...
module.exports = {
  ...
  /**
   * Gets a list of payment fee rules.
   * @param {Object} params                Parameters object
   * @return {Promise}                     Promise; if fulfilled returns object, which contains payment fee rules; if rejected returns APIerror.
   */
  getPaymentFeeRules: function (params) {
    const client = this;
    params = params || {};

    var url = "/v2/reference/payment_fee_rules";
